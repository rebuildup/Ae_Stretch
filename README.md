# stretch_v2 - After Effects エフェクトプラグイン

After Effects用のエフェクトプラグインです。アンカーポイントと角度に基づいてピクセルをストレッチします。

## 概要

`stretch_v2`は、指定したアンカーポイントと角度に基づいて画像をストレッチするエフェクトプラグインです。ピクセルを指定方向にシフトさせ、視覚的なストレッチ効果を生成します。
